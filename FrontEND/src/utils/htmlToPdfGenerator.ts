  ...
  try {
    ...
    const headerHTML = `
      <div style="margin-bottom: 30px;">
        <h1 style="color: #4ecca3; font-size: 32px; margin-bottom: 20px; font-family: Arial, sans-serif; border-bottom: 3px solid #4ecca3; padding-bottom: 15px;">
          AI Trading Performance Report
        </h1>
        <div style="background: rgba(78, 204, 163, 0.1); padding: 20px; border-radius: 12px; border-left: 4px solid #4ecca3; margin-bottom: 20px;">
        ...
        <div style="display: flex; gap: 15px; margin-bottom: 30px;">
          <div style="flex: 1; background: rgba(52, 211, 153, 0.15); padding: 18px; border-radius: 10px; border: 2px solid #34d399;">
            <div style="color: #34d399; font-size: 12px; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 8px;">Final Networth</div>
          ...
          <div style="flex: 1; background: rgba(59, 130, 246, 0.15); padding: 18px; border-radius: 10px; border: 2px solid #3b82f6;">
            <div style="color: #3b82f6; font-size: 12px; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 8px;">CAGR</div>
          ...
          <div style="flex: 1; background: rgba(${data.profitLoss >= 0 ? '34, 197, 94' : '239, 68, 68'}, 0.15); padding: 18px; border-radius: 10px; border: 2px solid ${data.profitLoss >= 0 ? '#22c55e' : '#ef4444'};">
            <div style="color: ${data.profitLoss >= 0 ? '#22c55e' : '#ef4444'}; font-size: 12px; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 8px;">Profit/Loss</div>
    ...
    footer.innerHTML = `
      <p style="color: #4ecca3; font-size: 14px; font-weight: bold; margin-bottom: 5px;">Generated by BullRun Game</p>
